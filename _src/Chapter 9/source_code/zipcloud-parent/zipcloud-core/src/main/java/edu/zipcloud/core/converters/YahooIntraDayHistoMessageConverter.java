...
public class YahooIntraDayHistoMessageConverter extends AbstractHttpMessageConverter<QuoteWrapper> {

    public YahooIntraDayHistoMessageConverter() {
    }

    public YahooIntraDayHistoMessageConverter(MediaType supportedMediaType) {
        super(supportedMediaType);
    }

    public YahooIntraDayHistoMessageConverter(MediaType... supportedMediaTypes) {
