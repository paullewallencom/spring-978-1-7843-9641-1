...
public class YahooQuoteMessageConverter extends AbstractHttpMessageConverter<QuoteWrapper> {

    public YahooQuoteMessageConverter() {
    }

    public YahooQuoteMessageConverter(MediaType supportedMediaType) {
        super(supportedMediaType);
    }

    public YahooQuoteMessageConverter(MediaType... supportedMediaTypes) {
